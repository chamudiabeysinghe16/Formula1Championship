...
public class UserInterface extends Formula1Driver {
    ...
    //Window listeners are commonly used to implement custom window-closing behavior.
    ...
    public static  void startMain() {
        ...
        JButton button5 = new JButton( new AbstractAction("ADD RACE") {
            ...
            public void actionPerformed( ActionEvent e ) {
                ...
                tableModel3.addColumn("Driver's name");
                tableModel3.addColumn("Position");
        ...
        JButton button6 = new JButton( new AbstractAction("RACE-DATES") {
            ...
            public void actionPerformed( ActionEvent e ) {
                ...
                tableModel2.addColumn("Driver's name");
                tableModel2.addColumn("Position");
        ...
        //stack OverFlow, not working properly
